...
const ZoomableImage = ({ src, alt, fallback }) => {
  ...
  const offsetY = -150; // Shifted up by 150px to sit clearly above the finger
                ...
                <form id="checkout-form" onSubmit={handleCheckoutSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="text" name="name" required placeholder="Your Name" onChange={handleInputChange} value={formData.name} className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:border-[#E60012] focus:ring-1 focus:ring-[#E60012]" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea name="address" required placeholder="House, Road, Area, City" rows="2" onChange={handleInputChange} value={formData.address} className="w-full bg-gray-50 border border-gray-200 rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:border-[#E60012] focus:ring-1 focus:ring-[#E60012]"></textarea>
                    </div>
                  </div>
