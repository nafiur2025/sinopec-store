            ...
            <div className="p-5 overflow-y-auto min-h-[300px]">
              ...
              {checkoutStep === 'success' && (
                <div className="flex flex-col items-center justify-center py-8 text-center animate-in zoom-in duration-300">
                  ...
                  {showConfetti && (
                    <div className="fixed inset-0 pointer-events-none z-[70] flex justify-center overflow-hidden">
                       ...
                       {Array.from({ length: 50 }).map((_, i) => (
                           <div
                               ...
                               style={{
                                   ...
                                   top: `-10px`,
                                   backgroundColor: ['#E60012', '#FFD700', '#00BFFF', '#32CD32'][Math.floor(Math.random() * 4)],
                                   animation: `fall ${Math.random() * 3 + 2}s linear infinite`,
                                   animationDelay: `${Math.random() * 5}s`
                               }}
                           />
